...
sudo -H pip3 install -U testresources setuptools grpcio wrapt astor google-pasta opt-einsum==2.3.2 numpy==1.16.0 gast==0.2.2 absl-py protobuf keras_preprocessing termcolor tensorflow-estimator==1.15.1 h5py==2.10.0 keras-applications tensorboard==1.15.0

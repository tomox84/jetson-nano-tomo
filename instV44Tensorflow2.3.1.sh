...
sudo -H pip3 install -U numpy==1.16.0 gast==0.3.3 tensorboard==2.3.0 astunparse==1.6.3 h5py==2.10.0 tensorflow-estimator==2.3.0 keras-preprocessing==1.1.1 absl-py==0.7.0 opt-einsum termcolor wrapt google-pasta grpcio
